...
-   Code
    -   Weighted dice (We will code this one together; [play_ground.R](play_ground.R) & [dice.R](dice.R))
...
-   Reading list
    ...
    -   [Hands-on Programming with R](https://rstudio-education.github.io/hopr/) (Chapter 1 to 3; Chapter 4 to 7, 9 and 11)

### Session 3, 4
    
-   [Slides](r_intro_part2.pdf)
-   Code
    -   Linear Regression - Base R (R Notebook [![](colab-badge.svg)](https://colab.research.google.com/github/tdmdal/r-intro-2023-fall/blob/master/docs/Housing_Prices_Regression_Analysis_(with_base_R).ipynb))
    -   Linear Regression - Tidyverse & Others (R Notebook [![](colab-badge.svg)](https://colab.research.google.com/github/tdmdal/r-intro-2023-fall/blob/master/docs/Housing_Prices_Regression_Analysis_(with_Tidyverse_and_Others).ipynb))
-   Reading list
